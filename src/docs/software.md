...
VALUES (1, 'Geyorgiy', 'geyorgi228@example.com', 'password');

-- Project
INSERT INTO `Project` (id, title, description, owner_id)
VALUES (1, 'Task Management Project', 'A project for managing tasks', 1);

-- Board
INSERT INTO `Board` (id, title, project_id)
VALUES (1, 'Main Board', 1);
...
VALUES (1, 'Set up project', 'Initial setup of the project structure', '2025-05-20', NULL, 'To Do', 1, 1);
