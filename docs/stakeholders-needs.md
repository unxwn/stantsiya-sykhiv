...
| Основний сценарій: |1. Користувач відкриває форму реєстрації<br>2. Вводить необхідні дані<br>3. Натискає "Зареєструватися"<br>4. Система перевіряє коректність даних<br>5. Якщо всі перевірки пройдені, акаунт створюється |
...
| Основний сценарій: |1. Користувач переходить у налаштування акаунту<br>2. Вносить зміни<br>3. Натискає "Зберегти"<br>4. Система перевіряє коректність введених даних<br>5. Якщо все коректно, система оновлює інформацію |
...
| Основний сценарій: |1. Користувач переходить у налаштування<br>2. Обирає "Видалити акаунт"<br>3. Підтверджує дію<br>4. Система видаляє акаунт |
...
| Основний сценарій: |1. Користувач натискає "Створити проєкт"<br>2. Заповнює необхідні поля<br>3. Підтверджує дію<br>4. Система перевіряє дані і створює проєкт |
...
| Основний сценарій: | 1. Користувач відкриває проєкт<br>2. Вносить зміни<br>3. Натискає "Зберегти"<br>4. Система перевіряє дані і зберігає зміни |
...
| Виключні ситуації: | - Доступ заборонено — AccessDeniedException |
| Основний сценарій: | 1. Користувач відкриває проєкт<br>2. Натискає "Видалити"<br>3. Підтверджує дію<br>4. Система видаляє проєкт |
...
| Основний сценарій: | 1. Адміністратор відкриває налаштування команди<br>2. Додає нових учасників, вводячи їхню пошту або ID<br>3. Система перевіряє дані та додає користувачів |
...
| Виключні ситуації: | - Доступ заборонено — AccessDeniedException |
| Основний сценарій: | 1. Адміністратор відкриває список учасників<br>2. Змінює права доступу для конкретного користувача<br>3. Система оновлює інформацію |
...
| Виключні ситуації: | - Доступ заборонено — AccessDeniedException |
| Основний сценарій: | 1. Адміністратор відкриває список учасників<br>2. Обирає учасника для видалення<br>3. Підтверджує видалення<br>4. Система видаляє учасника |
...
| Основний сценарій: | 1. Користувач відкриває проєкт<br>2. Натискає "Створити завдання"<br>3. Вводить назву, опис, дедлайн, виконавців<br>4. Підтверджує дію<br>5. Система перевіряє коректність даних<br>6. Завдання створено |
...
| Виключні ситуації: | - Доступ заборонено — AccessDeniedException |
| Основний сценарій: | 1. Користувач відкриває завдання<br>2. Вносить зміни (назва, опис, дедлайн, виконавці)<br>3. Натискає "Зберегти"<br>4. Система перевіряє коректність введених даних<br>5. Якщо дані коректні, система оновлює завдання |
...
| Виключні ситуації: | - Доступ заборонено — AccessDeniedException |
| Основний сценарій: | 1. Користувач відкриває завдання<br>2. Натискає "Видалити"<br>3. Підтверджує дію<br>4. Система видаляє завдання |
